 ...
 */
export const DEFAULT_PASTE_ID_LENGTH = envInt('PASTE_ID_LENGTH', 8)
...
export const CUSTOM_ID_MIN = envInt('PASTE_ID_MIN_CUSTOM',  4)
export const CUSTOM_ID_MAX = envInt('PASTE_ID_MAX_CUSTOM', 32)
